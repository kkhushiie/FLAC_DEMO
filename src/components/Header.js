...
export default function Header() {
    return (
     ...
     <Typography variant="h4" color={'black'} lineHeight={'40px'} fontWeight={'900'}  gutterBottom>
      ...
      <Typography variant="h6" color={'black'} gutterBottom>Lorem ipsum dolor sit.</Typography>
     ...
     <Button style={{ marginTop: '50px', color:"black" ,marginBottom:"4px", fontWeight: "bold", backgroundRepeat:"no-repeat", backgroundColor: "#E4E4E4", borderRadius: "20px",  width:"120px",  height:"140px", backgroundImage:`url(/FLAC/living.png)`,backgroundPositionX:"center" ,backgroundSize: "90px 90px"}} variant="contained"><Typography className='button-text'>Feature 3</Typography></Button>
     <Button style={{ marginTop: '50px', color:"black",  marginBottom:"4px", fontWeight: "bold", backgroundRepeat:"no-repeat", backgroundColor: "#E4E4E4", borderRadius: "20px",  width:"120px",  height:"140px", backgroundImage:`url(/FLAC/seat.png)`, backgroundPositionX: "center", backgroundSize: "110px 110px"}} variant="contained"><Typography className='button-text'>Feature 2</Typography></Button>
     <Button style={{marginTop: '50px', color:"#FE7122",marginBottom:"4px", fontWeight: "bold", backgroundRepeat:"no-repeat", backgroundColor: "#ECECEC", borderRadius: "20px",  width:"120px", height:"140px", backgroundImage:`url(/FLAC/food.png)`, backgroundPosition: "center", backgroundSize: "80px 70px"}} variant="contained"><Typography className='button-text'>Feature 1</Typography></Button>
     </Stack>
     </div>
    );
  }
